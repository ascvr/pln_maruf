...
<body onload="window.print()"  style="font-family:monospace;" >
	<table class="flash" style="background: url('../images/fp.png') center no-repeat;
			background-size: 50%;" >
		<tr>
		...
		<tr>
			<td colspan="6" align="center"><center>Flash Payment Menyatakan struk ini seabgai bukti pembayaran yang sah</center></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="6" align="center">Informasi Hubungi Call Center:890</td>
		</tr>
		<tr>
			<td colspan="6" align="center">FLASH PAYMENT - <?php echo $_SESSION['nama_agen'] ?></td>
		</tr>
		<tr>
			<td colspan="6" align="center"> <?php echo $pembayaran['waktu_bayar'];?> </td>
		</tr>
	</table>
</body>
</html>