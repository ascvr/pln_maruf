...
<body style="background:url('../images/petir.jpg');"  >
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-6">
					<div class="panel panel-default">
						...
						<div class="panel-footer">
							<strong> <center>&copy;<?php echo date("Y"); ?> - Flash Payment</center>
						</div>
						<!-- end footer -->
					</div>
				</div>
