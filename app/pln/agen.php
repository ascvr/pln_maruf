							...
							<div class="col-md-12">
								<form method="post">
									...
									<div class="form-group">
										...
										<input type="text" name="admin"  class="form-control" value="<?php echo @$edit['biaya_admin']; ?>" placeholder="Masukan Biaya Admin" required onkeypress="return event.charCode >=48 && event.charCode <= 57" maxlength="10">
									</div>
									<div class="form-group">
										<label>NAMA</label>
